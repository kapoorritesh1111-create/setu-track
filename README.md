...
This branch keeps the Phase 3A baseline intact and adds a narrow second release slice:

- approvals exception signals tightened into a true review workspace
- project budget-risk strip and risk-forward finance cues
- no new routes or schema changes
- existing pages only for lower release risk

## Phase 3B-R3

This branch adds the dedicated notifications workspace after the smaller R1 and R2 signal layers:

- new `/admin/notifications` workspace for managers and admins
- dashboard action-center handoff into the notifications workspace
